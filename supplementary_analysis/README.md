...
It differs from the main analysis in that it uses an alternative approach to estimating the first-level beta maps. The aim is to examine whether the conclusions of the main analysis also hold under these alternative analytical choices.
